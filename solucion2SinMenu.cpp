...
#define FILE "D1.txt"
#define FILE2 "D2.txt"
#define k  512.0  //con .0 para cuando cre las grillas nItems/k aproxime bien el valor
#define TEST 1
...
int main()
{
    ...
    cout << "Creando grilla con k: " << k << "...." << endl;
    unsigned char *palabra;
    string wordArray;
    ...
    */
    ...
    //Búsqueda despues de intentar insertar 5000 palabras 
    palabras_encontradas = 0;
    inicio = clock();
    cout << "Buscando las 10000 palabras de D2: \n.   .   .   .   .   .\n";
    for (int i = 0; i < SIZED2; i++)
